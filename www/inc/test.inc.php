<div class="row">
    <div class="col-md-12">
        <?php $disabled_language = (isset($_GET['page'])) ? ' disabled="disabled"' : ''; ?>
        <p>Язык вопроса:
            <label for="lang-ru">Русский</label> <input type="radio" id="lang-ru" name="language" value="ru" checked="checked"<?=$disabled_language?>>
            <label for="lang-en">English</label> <input type="radio" id="lang-en" name="language" value="en"<?=$disabled_language?>>
        </p>
    </div>
</div>
<div class="row">
